          ...
          >
            <View style={styles.fieldsContainer}>
              <Text style={styles.field}>
                {ticketType == "VISITOR" ? "На посещение" : "На въезд авто"}
              </Text>
            </View>
            ...
            <View style={styles.fieldsContainer}>
              <DatePickerComponent
                ...
                onUpdate={(date) => {
                  this.updateField(date, "visitDate");
                }}
                label="Дата *"
              ...
              {this.state.longTerm && (
                <DatePickerComponent
                  ...
                  date={
                    this.props.ticket.expirationDate
                      ? this.props.ticket.expirationDate
                      : new Date()
                  }
                  onUpdate={(date) => {
                    this.updateField(date, "expirationDate");
                  }}
                  label="Действует до *"
                  placeholder="Выберите дату"
                />
              ...
              {this.props.session.isLesnaya && (
                <PickerComponent
                  ...
                  onUpdate={(text) => {
                    this.updateField(text, "department");
                  }}
                />
              )}
            </View>
            {!(ticketType == "CAR" && this.state.isGroupRequest) && (
              <View style={styles.fieldsContainer}>
                {!this.state.isGroupRequest && (
                  <Fumi
                    style={[
                      styles.fumiStyle,
                      {
                        borderColor: this.props.fieldsHighlights.visitorFullName
                          ? Colors.accentColor
                          : "#FFF",
                      },
                    ]}
                    ...
                    onChangeText={(text) => {
                      this.updateField(text, "visitorFullName");
                    }}
                  />
                )}
                {ticketType == "VISITOR" && (
                  <Fumi
                    style={[
                      styles.fumiStyle,
                      {
                        borderColor: this.props.fieldsHighlights.whoMeets
                          ? Colors.accentColor
                          : "#FFF",
                      },
                    ]}
                    ...
                    inputStyle={styles.fumiInput}
                    onChangeText={(text) => {
                      this.updateField(text, "whoMeets");
                    }}
                  />
                )}
              </View>
                ...
                <View style={styles.fieldsContainer}>
                  ...
                  <TextInput
                    ...
                    style={[
                      ...
                      {
                        borderColor: this.props.fieldsHighlights
                    ...
                    scrollEnabled={true}
                    onChangeText={(text) => {
                      this.props.updateField(text, "groupRequestVisitorsData");
                    }}
                  />
                </View>
              </View>
                ...
                {!this.state.isGroupRequest && (
                  <View>
                    <Fumi
                      ...
                      inputStyle={styles.fumiInput}
                      onChangeText={(text) => {
                        this.updateField(text, "carModelText");
                      }}
                    />
                    <Fumi
                      style={[
                        styles.fumiStyle,
                        {
                          borderColor: this.props.fieldsHighlights.carNumber
                            ? Colors.accentColor
                            : "#FFF",
                        },
                      ]}
                      ...
                      inputStyle={styles.fumiInput}
                      onChangeText={(text) => {
                        this.updateField(text, "carNumber");
                      }}
                    />
                  </View>
                )}
            ...
            <View style={styles.fieldsContainer}>
              <TextInput
                ...
                scrollEnabled={true}
                onChangeText={(text) => {
                  this.props.updateField(text, "note");
                }}
              />
            </View>
          </View>
