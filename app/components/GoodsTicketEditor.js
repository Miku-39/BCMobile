          ...
          >
            <View style={styles.fieldsContainer}>
              <Text style={styles.field}>
                {this.props.ticketType == "GOODS_IN"
                  ? "Внос имущества"
                  : "Вынос имущества"}
              </Text>
            </View>
            ...
            <View style={styles.fieldsContainer}>
              <TextInput
                ...
                style={[
                  ...
                  {
                    borderColor: this.props.fieldsHighlights.materialValuesData
                      ? Colors.accentColor
                      : "#FFF",
                  },
                ]}
                ...
                scrollEnabled={true}
                onChangeText={(text) => {
                  this.props.updateField(text, "materialValuesData");
                }}
              />
            </View>
            <View style={styles.fieldsContainer}>
